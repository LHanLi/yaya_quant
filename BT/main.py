...
# BT single security 
def BT(df_price,Strategy,start=datetime.datetime(2014, 1, 21),end=datetime.datetime(2021,1, 21)):
    import csv
...
#    # pingjia 
    ...
    f.write("%s     %.3f     %s \n"%(df_price.index_name[0],cerebro.broker.getvalue(),strat.analyzers._SharpeRatio.get_analysis()['sharperatio']))
    f.close()
    # Plot the result
